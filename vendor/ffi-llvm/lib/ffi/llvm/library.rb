...
module FFI
  module LLVM
    ...
    attach_function :"LLVMVerifyFunction", [:llvm_value_ref, :llvm_verifier_failure_action], :llvm_bool
    attach_function :"LLVMLinkInMCJIT", [], :void
    attach_function :"LLVMInitializeX86TargetMC", [], :void
    attach_function :"LLVMCreateJITCompilerForModule", [:llvm_execution_engine_ref, :llvm_module_ref, :uint, :pointer], :llvm_bool
    attach_function :"LLVMCreateExecutionEngineForModule", [:llvm_execution_engine_ref, :llvm_module_ref, :pointer], :llvm_bool
    attach_function :"LLVMCreateGenericValueOfInt", [:llvm_type_ref, :uint64, :llvm_bool], :llvm_generic_value_ref
    attach_function :"LLVMRunFunction", [:llvm_execution_engine_ref, :llvm_value_ref, :uint, :llvm_generic_value_ref], :llvm_generic_value_ref
    attach_function :"LLVMCreatePassManager", [], :llvm_pass_manager_ref
    attach_function :"LLVMRunPassManager", [:llvm_pass_manager_ref, :llvm_module_ref], :llvm_bool
    attach_function :"LLVMDumpModule", [:llvm_module_ref], :void
